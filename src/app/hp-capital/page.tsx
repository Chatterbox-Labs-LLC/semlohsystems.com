...
export const metadata: Metadata = {
  title: "Semloh Trading Group | Quantitative Investing",
  description: "Semloh Trading Group (formerly HP Capital) is the systematic trading arm of Semloh, specializing in research-driven mathematical investing.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-black mb-16 uppercase leading-tight">
            Semloh Trading Group
          </h1>
          
          <div className="space-y-12">
            <section className="space-y-6">
              <p className="text-xl text-black font-normal leading-relaxed opacity-80">
                Semloh Trading Group is the systematic trading arm of Semloh, where every investment decision is rooted in deep mathematical research and statistical validation.
              </p>
