          ...
          <div className="space-y-12">
            <section className="space-y-6">
              <p className="text-xl text-black font-normal leading-relaxed opacity-80">
                HP Capital is the systematic trading arm of Semloh Systems Corp. We specialize in the development and execution of quantitative strategies across liquid global equity markets.
              </p>
              <p className="text-lg text-black font-normal leading-relaxed opacity-60">
                Our approach to asset management is defined by rigorous statistical analysis and a deep understanding of market microstructure. We leverage proprietary data sets and advanced modeling techniques to identify and capture market inefficiencies in a systematic, risk-controlled manner.
              </p>
            </section>
          </div>
        </div>
