...
export const metadata: Metadata = {
  title: "Legal & Compliance | Semloh",
  description: "Corporate governance, regulatory disclosures, and risk warnings for Semloh, Semloh Trading Group, and Semloh Software Systems LLC.",
};
  ...
  const sections = [
    {
      ...
      content: [
        "Semloh is a private enterprise incorporated under the laws of the State of Delaware, United States. Headquartered in Chicago, Illinois, the corporation serves as the ultimate parent company and strategic holding entity for a diversified group of specialized financial and technological subsidiaries.",
        "The corporate architecture is designed to maintain strict operational separation between our investment management and technology development arms. Our primary domestic subsidiaries include Semloh Trading Group, which manages systematic trading operations, and Semloh Software Systems LLC, which handles proprietary infrastructure and platform development.",
        "Our governance framework emphasizes transparency, risk mitigation, and long-term value creation. By centralizing strategic oversight at the parent level while decentralizing execution at the subsidiary level, Semloh ensures that each division maintains the agility required to excel in its respective domain while benefiting from the group's collective resources and stability."
      ]
    },
    {
      title: "Fund Domicile & Cayman Islands Operations",
      content: [
        "The investment funds managed by Semloh Trading Group are domiciled in the Cayman Islands. This jurisdiction was selected for its sophisticated legal framework, tax neutrality, and internationally recognized regulatory environment for alternative investment vehicles.",
    ...
    },
    {
      ...
      content: [
        "Semloh Trading Group operates in full compliance with applicable financial regulations in every jurisdiction where it maintains a presence. All trading activities are conducted through regulated exchanges and authorized clearing members.",
    ...
    },
    {
      title: "Risk Warning",
      content: [
        "Quantitative trading involves a high degree of risk and is not suitable for all investors. The systematic strategies employed by Semloh Trading Group rely on complex mathematical models and historical data which may not accurately predict future market behavior.",
    ...
    },
    {
      ...
      content: [
        "All content on this website, including but not limited to text, graphics, logos, software architecture descriptions, and proprietary research summaries, is the exclusive property of Semloh or its subsidiaries.",
    ...
    },
    {
      ...
      content: [
        "We are committed to maintaining the confidentiality and security of all information provided to us. Semloh does not sell or lease personal data to third-party marketers.",
    ...
    },
    {
      ...
      content: [
        "Semloh provides the information on this website 'as is' without any warranties, express or implied. We shall not be liable for any direct, indirect, incidental, or consequential damages arising from the use of, or inability to use, the materials on this site.",
          ...
          <div className="space-y-16">
            ...
            <div className="pt-16 border-t border-black/5">
              <p className="text-[10px] font-bold uppercase tracking-widest opacity-30">
                ...
                © 2026 Semloh. All rights reserved.
              </p>
            </div>
          </div>
        </div>
